...
class EC2(Service):
    ...
    class SecurityGroup(Service.Resource):
        ...
        @staticmethod
        def _detach_from_instances(cl: boto3.client, security_group_id: str) -> List[Dict]:
            """
        ...
        def destroy(arn: str, region: str, dry: bool = True) -> List[Dict]:
            ...
            resps.extend(EC2.SecurityGroup._detach_from_instances(cl, security_group_id))
